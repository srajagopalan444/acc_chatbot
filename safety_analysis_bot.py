...
st.write("X_train_ids:", type(X_train_ids))
st.write("X_train_masks:",type(X_train_masks))
st.write("X_test_ids:",type(X_test_ids))
st.write("X_test_masks:",type(X_test_masks))
