...
st.write("Shape of X_train:",X_train_ids[0])
st.write("Shape of X_test:",X_train_masks[0])
st.write("Shape of y_train:",X_test_ids[0])
st.write("Shape of y_test:",X_test_masks[0])
